...
#' @export
vec_cast.untsq.dnasq <- function(x, to, ...) .construct_untsq(as.character(x), alph = .get_alph(to))
#' @export
...
#' @export
vec_cast.untsq.rnasq <- function(x, to, ...) .construct_untsq(as.character(x), alph = .get_alph(to))
#' @export
...
vec_cast.untsq.untsq <- function(x, to, ...)
  if (identical(.get_alph(x), .get_alph(to))) x else .construct_untsq(as.character(x), alph = .get_alph(to))
#' @export
vec_cast.untsq.character <- function(x, to, ...) .construct_untsq(x, alph = .get_alph(to))
#' @export
...
vec_cast.atpsq.atpsq <- function(x, to, ...)
  if (identical(.get_alph(x), .get_alph(to))) x else .nonst_construct_sq(as.character(x), .get_alph(to))
#' @export
vec_cast.atpsq.character <- function(x, to, ...) .nonst_construct_sq(x, .get_alph(to))
#' @export
