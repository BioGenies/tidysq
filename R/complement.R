...
#' 
#' @details This functions allows to obtain a complement sequence, which is created by 
...
#' tries to guess, which type of sequence was entered. If a sequence contains 'U' without 
