...
#' @export
remove_ambiguous.default <- function(x, by_letter, ...)
  stop("ambiguous letters are not defined in the context of this class", call. = FALSE)

#' @export
remove_ambiguous.sq_dna_bsc <- function(x, by_letter, ...) x

#' @export
remove_ambiguous.sq_dna_ext <- function(x, by_letter, ...)
  CPP_remove_ambiguous(x, by_letter, get_standard_alphabet("sq_dna_bsc"))

#' @export
remove_ambiguous.sq_rna_bsc <- function(x, by_letter, ...) x

#' @export
remove_ambiguous.sq_rna_ext <- function(x, by_letter, ...)
  CPP_remove_ambiguous(x, by_letter, get_standard_alphabet("sq_rna_bsc"))

#' @export
remove_ambiguous.sq_ami_bsc <- function(x, by_letter, ...) x

#' @export
remove_ambiguous.sq_ami_ext <- function(x, by_letter, ...)
