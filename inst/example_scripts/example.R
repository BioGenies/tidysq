...
sqtbl_1 <- tidysq:::construct_sqtibble(c("name2", "name3", "name4"), list(sq_2, sq_3, sq_4))
sqtbl_2 <- tidysq:::construct_sqtibble(c("name2", "name3"), list(sq_2, sq_3))
sqtbl_3 <- tidysq:::construct_sqtibble(c("name1", "name3", "name4"), list(sq_1, sq_3, sq_4))
